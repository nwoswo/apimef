...
public class ReniecLocator extends org.apache.axis.client.Service implements localhost.ws.Reniec {
    ...
    private java.lang.String ReniecSoap_address = "http://vwd-srv01.mef.gob.pe/ws/reniec.asmx";
    ...
    public localhost.ws.ReniecSoap getReniecSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            localhost.ws.ReniecSoapStub _stub = new localhost.ws.ReniecSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (localhost.ws.ReniecSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                localhost.ws.ReniecSoapStub _stub = new localhost.ws.ReniecSoapStub(new java.net.URL(ReniecSoap_address), this);
                _stub.setPortName(getReniecSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost/ws", "Reniec");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost/ws", "ReniecSoap"));
        }
