ventanillaVirtual.controller('enviarnotiusuariosController', function (
  $scope,
  notiService,
  $ngBootbox,
  $uibModalInstance,
    ...
    $ngBootbox
      ...
      .then(
        ...
        function () {
          ...
          notiService.EnviarNotifiacionUsuarios($scope.ListaDetalle,$scope.model.mensaje, $scope.files)
